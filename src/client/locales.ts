...
const zh = {
  ...
  'seg.tps': '吞吐 TPS',
  'seg.tpsHint': '实时生成速率：host 侧实时折叠流式 chunk 估算（约 4 字符/token，provider 上报用量后转精确），空闲时保持最近一次速率，每 0.5 秒刷新一次。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'seg.tpsHint': 'Live generation rate: the host folds stream chunks in real time (~4 chars/token estimate, exact once the provider reports usage); keeps the latest rate while idle, refreshing at most every 0.5 s.',
